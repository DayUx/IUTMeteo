...
function createElem(obj, idx, tab) {
    ...
    humiditeIcon = $("<img>").attr("src", "./img/water.svg");
...
function search(search) {
    ...
    $.ajax({
        url: "https://api.openweathermap.org/data/2.5/forecast/daily?lat=" + search.lat + "&lon=" + search.lon + "&units=metric&lang=fr&cnt=7&appid=ee07e2bf337034f905cde0bdedae3db8",
        type: "GET",
        dataType: "json",
...
function position(position) {
    $.ajax({
        url: "https://api.openweathermap.org/data/2.5/forecast/daily?lat=" + position.coords.latitude + "&lon=" + position.coords.longitude + "&units=metric&lang=fr&cnt=7&appid=ee07e2bf337034f905cde0bdedae3db8",
        type: "GET",
        dataType: "json",
        success: function (data) {
            if (data.city.name == "") {
